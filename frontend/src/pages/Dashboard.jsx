...
import VideoCard from "../components/video/VideoCard.jsx";import VideoPlayer from "../components/video/VideoPlayer.jsx";import VideoSkeleton from "../components/ui/VideoSkeleton.jsx";import { fetchMyVideos, uploadVideo, deleteVideo, updateVideo } from "../store/slices/videoSlice.js"
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 text-white flex items-center justify-center">
        <div className="text-center space-y-6">
          <h1 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">You are not logged in</h1>
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 via-black to-gray-950 text-white">
        ...
        <div className="flex flex-col gap-4 sm:gap-6 -mt-16 sm:-mt-20 md:-mt-24 lg:-mt-28 mb-6 sm:mb-8">
          ...
          <div className="flex-1">
            <div className="mb-2 sm:mb-3">
              <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-1 sm:mb-2 bg-gradient-to-r from-white via-gray-100 to-gray-300 bg-clip-text text-transparent">{user.fullName}</h1>
            ...
            <div className="flex flex-col sm:flex-row sm:flex-wrap sm:items-center gap-3 sm:gap-4 mb-3 sm:mb-4 text-sm text-gray-300">
              ...
              <div className="flex items-center gap-1">
                <span className="text-white font-bold text-lg">{myVideos.length}</span>
                <span className="text-gray-400">Video{myVideos.length !== 1 ? 's' : ''}</span>
              </div>
            </div>
          ...
          <div className="flex gap-2 sm:gap-3 w-full sm:w-auto">
            <button
              className="flex-1 sm:flex-none bg-white text-black px-6 sm:px-8 py-2.5 sm:py-3 text-sm sm:text-base rounded-full font-semibold hover:bg-gray-100 hover:shadow-lg transition-all duration-300 transform hover:scale-105"
            >
              Subscribe
            </button>
            <button
      ...
      {showUploadForm && (
        <div className="px-3 sm:px-4 md:px-6 lg:px-8 mb-6 sm:mb-8">
          ...
          >
            ...
            <div>
              <label className="block text-sm font-semibold text-gray-200 mb-2">Video Title *</label>
              <input
                type="text"
                name="title"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-semibold text-gray-200 mb-2">Video File *</label>
                <input
                  type="file"
                  name="video"
                  accept="video/*"
              ...
              <div>
                <label className="block text-sm font-semibold text-gray-200 mb-2">Thumbnail (Optional)</label>
                <input
                  type="file"
                  name="thumbnail"
                  accept="image/*"
      ...
      <div className="px-3 sm:px-4 md:px-6 lg:px-8 pb-8 sm:pb-10">
        <div className="flex items-center gap-2 mb-6">
          ...
          <h2 className="text-2xl md:text-3xl font-bold text-white">Your Videos</h2>
          <span className="ml-auto text-sm text-gray-400 font-medium">{myVideos.length} video{myVideos.length !== 1 ? 's' : ''}</span>
        </div>
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-16 sm:py-20 bg-gradient-to-b from-gray-800/20 to-gray-900/20 rounded-2xl border border-gray-700/30">
            ...
            <p className="text-gray-300 text-lg font-medium mb-1">No videos uploaded yet</p>
            ...
            {myVideos.map((video) => (
              ...
              >
                <VideoCard
                  ...
                  onMenuClick={() => setOpenMenuId(openMenuId === video._id ? null : video._id)}
                />
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4 overflow-y-auto">
          <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl p-6 sm:p-8 shadow-2xl max-w-2xl w-full border border-gray-700/50 my-8">
            ...
            <form onSubmit={(e) => {
              ...
              {/* Video File (Optional) */}
              <div>
                <label className="block text-sm font-semibold text-gray-200 mb-2">Video File (Optional)</label>
                <input
                  type="file"
                  name="videoFile"
                  accept="video/*"
                  onChange={(e) => setUpdateData({ ...updateData, videoFile: e.target.files[0] })}
                ...
                />
                <p className="text-xs text-gray-500 mt-2">Leave empty to keep current video</p>
              </div>
